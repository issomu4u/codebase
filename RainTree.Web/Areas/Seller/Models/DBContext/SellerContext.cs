...
namespace SellerVendor.Areas.Seller.Models.DBContext
{
    public class SellerContext : DbContext
    {
        ...
        public DbSet<MarketPlaceOrderEntity> MarketPlaceOrderEntity { get; set; }
        public DbSet<tbl_api_meter> tbl_api_meter { get; set; }//done
        public DbSet<tbl_sellers> tbl_sellers { get; set; }//done
        public DbSet<m_marketplace> m_marketplace { get; set; }//done
        public DbSet<tbl_user_login> tbl_user_login { get; set; }//done
        public DbSet<m_database> m_database { get; set; }//done

        public DbSet<tbl_country> tbl_country { get; set; }//done
        public DbSet<m_source_of_joining> m_source_of_joining { get; set; }//done      
        public DbSet<tbl_exception_history> tbl_exception_history { get; set; }//done
        public DbSet<m_item_category> m_item_category { get; set; }//done
        public DbSet<m_item_subcategory> m_item_subcategory { get; set; }//done     
        public DbSet<temp_item_category> temp_item_category { get; set; }//done
        public DbSet<temp_item_subcategory> temp_item_subcategory { get; set; }//done
        public DbSet<tbl_m_plan> tbl_m_plan { get; set; }//done
        public DbSet<tbl_seller_type> tbl_seller_type { get; set; }//done
        public DbSet<tbl_user_payment> tbl_user_payment { get; set; }//done

        public DbSet<MarketPlaceOrderItemEntity> MarketPlaceOrderItemEntity { get; set; }
        public DbSet<MarketPlaceOrderItemReturnTransactionEntity> MarketPlaceOrderItemReturnTransactionEntity { get; set; }
        public DbSet<MarketPlaceOrderItemSettlementTransactionEntity> MarketPlaceOrderItemSettlementTransactionEntity { get; set; }
        public DbSet<MarketPlaceOrderItemTransactionEntity> MarketPlaceOrderItemTransactionEntity { get; set; }

        public DbSet<MarketPlaceSettlementEntity> MarketPlaceSettlementEntity { get; set; }
        public DbSet<MarketPlaceSettlementItemEntity> MarketPlaceSettlementItemEntity { get; set; }
        public DbSet<MarketPlaceSettlementItemTransactionEntity> MarketPlaceSettlementItemTransactionEntity { get; set; }
        public DbSet<MarketPlaceSettlementOrderTransactionEntity> MarketPlaceSettlementOrderTransactionEntity { get; set; }
        public DbSet<MarketPlaceSettlementTransactionEntity> MarketPlaceSettlementTransactionEntity { get; set; }
        public DbSet<MarketPlaceTransactionTypeEntity> MarketPlaceTransactionTypeEntity { get; set; }
        public DbSet<ItemEntity> ItemEntity { get; set; }
        public DbSet<SellerSettingMarketplaceEntity> SellerSettingMarketplaceEntity { get; set; }
