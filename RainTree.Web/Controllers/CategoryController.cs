...
namespace SellerVendor.Controllers
{
    public class CategoryController : Controller
    {
        ...
        SellerContext db = new SellerContext();
        SellerContext dba = new SellerContext();
            ...
            try
            {
                ...
                using (var transaction = cf.CreateTransactionScope())
                {
                    ...
                    if (AddSubCategory.id == 0)
                    {
                        ...
                        dba.m_item_subcategory.Add(m_subCategory_Details);
                        dba.SaveChanges();
                    ...
                    {
                        var subcategory_details = dba.m_item_subcategory.Where(a => a.id == AddSubCategory.id).FirstOrDefault();
